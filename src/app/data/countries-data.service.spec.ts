...
describe('CountriesDataService', () => {
  ...
  beforeEach(() => {
    ...
    (httpClient.get as any).and.returnValue(of(countriesData));
    service = new CountriesDataService(httpClient);
  });

  describe('countries', () => {
    it('Exposes all countries records', () => {
      return service.countries
        .pipe(
          last(),
          tap((result: Country[]) => {
            expect(result).toBe(countriesData);
          })
        )
        .toPromise();
    });
